...
\newcommand{\targetFlag}{test_} %leeres Feld: Originalbilder, ``test_``-Feld: Testbilder
\newcommand{\ssigma}{1} %standard deviation of directional gradient kernel
\newcommand{\templateThresh}{0.7} %relative threshold for binarization of the template image
\newcommand{\objThresh}{0.2} %relative threshold for maxima in hough space
...
\newcommand{\angleSteps}{180} %angle resolution in terms of number of angles to be investigated
